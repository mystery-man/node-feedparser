...
function FeedParser (options) {
  ...
  if (!('strip_title_html' in this.options)) this.options.strip_title_html = false;
  if (!('strip_desc_html' in this.options)) this.options.strip_desc_html = false;
...
FeedParser.prototype.handleMeta = function handleMeta (node, type, options) {
  ...
  var meta = {}
    ...
    , stripTitleHtml = !options || (options && options.strip_title_html)
    , stripDescriptionHtml = !options || (options && options.strip_desc_html)
    ;
